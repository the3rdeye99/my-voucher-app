...
import { FaHome, FaUsers, FaFileInvoiceDollar, FaBell, FaCog, FaSignOutAlt, FaVolumeUp, FaVolumeMute } from 'react-icons/fa';
  ...
  return (
    <div className="bg-gray-800 text-white w-64 min-h-screen p-4">
      ...
      <nav>
        ...
        <Link href="/admin-dashboard/users" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaUsers />
          <span>Users</span>
        </Link>
        <Link href="/admin-dashboard/vouchers" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaFileInvoiceDollar />
          <span>Vouchers</span>
        </Link>
        <button
        ...
        <Link href="/admin-dashboard/settings" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaCog />
          <span>Settings</span>
        </Link>
        <button
