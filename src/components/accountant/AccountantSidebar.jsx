...
export default function AccountantSidebar({ user }) {
  ...
  return (
    <div className="bg-gray-800 text-white w-64 min-h-screen p-4">
      ...
      <nav>
        <Link href="/accountant-dashboard" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaHome />
          <span>Home</span>
        </Link>
        <Link href="/accountant-dashboard/vouchers" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaFileInvoiceDollar />
          <span>Vouchers</span>
        </Link>
        <button
        ...
        <Link href="/accountant-dashboard/settings" className="flex items-center space-x-2 p-2 hover:bg-gray-700 rounded">
          <FaCog />
          <span>Settings</span>
        </Link>
        <button
